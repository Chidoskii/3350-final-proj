      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="./pages/best.php?mov=curr">Latest Releases</a></li>
            <li><a class="dropdown-item" href="./pages/best.php?mov=all">Best Movies All Time </a></li>
            <li><a class="dropdown-item" href="./pages/best.php?mov=act">Best Action Movies</a></li>
            <li><a class="dropdown-item" href="./pages/best.php?mov=com">Best Comedy Movies</a></li>
            <li><a class="dropdown-item" href="./pages/best.php?mov=horr">Best Horror Movies</a></li>
          </ul>
        </li>
      </ul>
